...
const config = {
    ...
    OTP_EXPIRY: 300000,
    NEWS_JSON_URL: '',
    BOT_NAME: '⛓ᴍᴀᴅᴜꜱʜᴀɴᴋᴀ ᴍᴅ ᴍɪɴɪ ʙᴏᴛ⛓',
    OWNER_NAME: 'ᴅᴀᴍɪᴛʜ ᴍᴀᴅᴜꜱʜᴀɴᴋᴀ',
    OWNER_NUMBER: '+94743387798',
    BOT_VERSION: '1.0.0',
    BOT_FOOTER: '> ᴍᴀɪɴᴛᴀɴᴀɴᴄᴇ ᴅᴀᴍɪᴛʜ ᴍᴀᴅᴜꜱʜᴀɴᴋᴀ.',
...
async function updateAboutStatus(socket) {
    const aboutStatus = 'ᴍᴀᴅᴜꜱʜᴀɴᴋᴀ ᴍᴅ 𝙰𝙲𝚃𝙸𝚅𝙴 𝙽𝙾𝚆𝙴💥😽';
    try {
...
//================================ ALIVE ==================================
    ...
    try {
        ...
        const content = 
`𝗜'𝗺 𝙈𝙖𝙙𝙪𝙨𝙝𝙖𝙣𝙠𝙖-𝙈𝙙 𝗠𝗶𝗻𝗶 𝗕𝗼𝘁 𝗠𝗮𝗱𝗲 𝗕𝘆 𝘿𝙖𝙢𝙞𝙩𝙝 𝙈𝙖𝙙𝙪𝙨𝙝𝙖𝙣𝙠𝙖🕊️❤️‍🩹.
...
🌐 ᴍᴀᴅᴜꜱʜᴀɴᴋᴀ ᴍɪɴɪ вσт is a lightweight yet powerful WhatsApp user bot ⚡ 
...
//============================== OWNER ===============================
        ...
        await socket.sendMessage(sender, {
                            contacts: {
                                displayName: "ᴍᴀᴅᴜꜱʜᴀɴᴋᴀ ᴍᴅ Mini Bot Ofc. Owner",
                                contacts: [{ vcard }]
                            }
                        });     
                break;     
...
//================================ SYSTEM ==================================                   
  ...
  const title = '*ᴍᴀᴅᴜꜱʜᴀɴᴋᴀ xmd System Info*';
  const content = `┏━━━━━━━━━━━━━━━━\n` +
    `┃🤖 \`ʙᴏᴛ ɴᴀᴍᴇ\` : ${config.BOT_NAME}\n` +
    `┃🔖 \`ᴠᴇʀsɪᴏɴ\` : ${config.BOT_VERSION}\n` +
    `┃📡 \`ᴘʟᴀᴛꜰᴏʀᴍ\` : Heroku\n` +
...
case 'song': {
    try {
        ...
        const titleText = '*✘ ᴍᴀᴅᴜꜱʜᴀɴᴋᴀ-MD Songs*';
        const content = `┏━━━━━━━━━━━━━━━━\n` +
            `┃📝 \`Title\` : ${video.title}\n` +
            `┃📈 \`Views\` : ${video.views}\n` +
                ...
                try {
                    ...
                    await socket.sendMessage(userJid, {
                        ...
                        caption: formatMessage(
                            ...
                            '> ᴀʟʟ ʀɪɢʜᴛ ʀᴇꜱᴇʀᴠᴇᴅ ᴛᴏ ᴍᴀᴅᴜꜱʜᴀɴᴋᴀ-ᴍᴅ'
                        )
                    });
